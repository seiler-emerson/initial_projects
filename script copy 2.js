...
function teste() {
    const { totalViewProjection, totalClicksProjection, totalShareProjection } = Calc()

    let c1 = totalViewProjection
    let c2 = totalClicksProjection
    let c3 = totalShareProjection
