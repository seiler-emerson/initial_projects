...
function Pomodoro() {                      
    timer = setInterval(()=>{                                                                               //Timer de 1 segundo
        ...
        document.querySelector('#second').innerHTML = fixZero(secondPomodoro);                              //Exibição do segundo atual na tela -1 segundo, para exibir de 0 a 59 segundos
        ...
        if(secondPomodoro <= 0 && minuteSPomodoro < 1500 && minuteSPomodoro > 0){                           //Se os segundos forem menor ou igual a 0 | E os minutos menores que 120 e maiores que 0                                 
...
function longbreak() {
    ...
    timer = setInterval(()=>{                                                                               //Timer de 1 segundo
        ...
        document.querySelector('#second').innerHTML = fixZero(secondLongBreak);                             //Exibição do segundo atual na tela -1 segundo, para exibir de 0 a 59 segundos
        ...
        if(secondLongBreak <= 0 && minuteSLongBreak < 1500 && minuteSLongBreak > 0){                        //Se os segundos forem menor ou igual a 0 | E os minutos menores que 120 e maiores que 0                                 
            secondLongBreak = 60;                                                                           //Reiniciar os segundos em 60                                                                                          //E rodar a função timer novamente
